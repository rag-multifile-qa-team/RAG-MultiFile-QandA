...
def get_whisper_runtime(device: str):
    """
    faster-whisper runtime seçimi.
    - CUDA varsa: cuda + float16 hızlı
    - MPS genelde faster-whisper tarafında kararsız olabildiği için CPU+int8 daha stabil
    """
    if device == "cuda":
        return "cuda", "float16"

    # mps veya cpu -> cpu int8 (stabil ve hafif)
    return "cpu", "int8"
...
# -----------------------------
# Helpers: Multilingual instruction
# -----------------------------
...
# -----------------------------
# Helpers: Voice input (mic -> whisper)
# -----------------------------
